...
const SendMoney = () => {
  ...
  const getAccounts = async () => {
    try {
      const response = await fetch("https://minorproject-u04v.onrender.com/api/account/getUserAccounts", {
        method: "GET",
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://minorproject-u04v.onrender.com/api/payments/makePayment", {
        method: "POST",
        headers: {
